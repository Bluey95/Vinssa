...
class DrugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post drugs_url, params: { drug: { desc: @drug.desc, expiration: @drug.expiration, name: @drug.name, price: @drug.price, quantity: @drug.quantity } }
    end
  ...
  test "should update drug" do
    patch drug_url(@drug), params: { drug: { desc: @drug.desc, expiration: @drug.expiration, name: @drug.name, price: @drug.price, quantity: @drug.quantity } }
